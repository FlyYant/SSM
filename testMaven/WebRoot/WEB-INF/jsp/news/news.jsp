    ...
    <form action="${ctx}/news/findBySql" id="listform" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px">
                ...
                <li>
                    <input type="text" placeholder="请输入公告标题" name="title" class="input" value="${obj.title}"
...
<%--                    <a class="button border-main" href="${ctx}/news/findBySql2?id=${data.id}"><span class="icon-edit">详情</span> </a>--%>
