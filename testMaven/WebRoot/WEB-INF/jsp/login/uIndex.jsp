...
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            ...
            <span class="block_yh left_yh fff" style="height: 45px;line-height: 45px;margin-left: 10px;">分类</span>
            <!--导航展开部分-->
            <div class="downSlide">
                <c:forEach items="${lbs}" var="data" varStatus="1">
                    <div class="n1Nav">
                        <font>${data.father.lbname}</font>
                        <img src="${ctx}/resource/user/images/jt.png" alt="">
                        <div class="n2Nav">
                            <div class="n3Nav">
                                <h3>${data.father.lbname}</h3>
                                <c:forEach items="${data.childrens}" var="child" varStatus="11">
                                    <a href="${ctx}/product/shoplist?cplbTwo=${child.id}">${child.lbname}</a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index: 80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/e.webp" alt=""></li>
            <li><img src="${ctx}/resource/images/f.webp" alt=""></li>
            <li><img src="${ctx}/resource/images/g.webp" alt=""></li>
            <li><img src="${ctx}/resource/images/h.webp" alt=""></li>
        </ul>
    </div>
    <script>
        $(function(){
    ...
    <div class="width100 hidden_yh" style="height: 480px;">
        <div class="normalPic">
            <c:forEach items="${zks}" var="data" varStatus="1">
                <a href="${ctx}/product/view?id=${data.id}">
                    <h3 class="yihang c_33 font14 font100" style="padding-left: 10px;padding-right: 10px;">${data.pname}</h3>
