...
<div class="width1198 center_yh" style="height: 35px;background: #f0f0f0;border: 1px solid #ddd;margin-top: 25px;">
    <a href="${ctx}/product/shoplist?cplbTwo=${obj.cplbTwo}" class="mR">默认</a>
    <a href="${ctx}/product/shoplist?price=1&cplbTwo=${obj.cplbTwo}" class="mR">
        价格
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
    <a href="${ctx}/product/shoplist?gyNum=1&cplbTwo=${obj.cplbTwo}" class="mR">
        销量
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
</div>
...
<div class="width1200 center_yh hidden_yh" style="margin-top: 25px;">
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="1">
            <li>
                <a href="${ctx}/product/view?id=${data.id}" class="bjK">
                    <img src="${data.url1}" alt="">
                </a>
                <h3 class="spName">${data.pname}</h3>
                <p class="center_yh block_yh hidden_yh"style="width: 202px;">
                    ...
                    <c:if test="${data.zk!=null}">
                        <font class="right_yh red font14">
                            ${data.zk}
                ...
                <div class="wCa">
                    <a href="${ctx}/sc/exAdd?productId=${data.id}" class="fav">
                        <div class="wCa1">
...
<div id="navs">
    <div class="pagelist">
        <!--分页开始-->
        <pg:pager url="${ctx}/product/shoplist" maxIndexPages="5" items="${pagers.total}" maxPageItems="10" export="curPage=pageNumber">
            <pg:param name="cplbTwo" value="${obj.cplbTwo}"/>
...
<script>
    function addcar(id) {
        $.ajax({
            type:"POST",
            url:"${ctx}/cart/exAdd?productId="+id+"&num=1",
