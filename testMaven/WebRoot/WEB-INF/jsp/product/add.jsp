...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form action="${ctx}/product/exAdd" method="post" class="form-x" enctype="multipart/form-data">
            <div class="form-group">
                <div class="label"><label>商品名称:</label></div>
                <div class="field">
                    <input type="text" class="input w50" name="pname" data-validate="required:请输入商品名称"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="pguishu" data-validate="required:请输入产品产地"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="psum" data-validate="required:请输入商品数量"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <select name="cplbTwo" class="input w50">
                        <c:forEach items="${types}" var="data" varStatus="1">
                            <option value="${data.id}">${data.lbname}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
