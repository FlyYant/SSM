    ...
    <div class="width1200 hidden_yh center_yh">
        ...
        <div id="vipRight">
            <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                <div class="width100 font20" style="height: 60px;line-height: 60px;text-indent: 50px;background: #f5f8fa;border-bottom: 1px solid #ddd;">
                    最近收藏
                </div>
                <div class="hidden_yh" style="padding: 20px;width: 898px;">
                    <c:forEach items="${pagers.datas}" var="data" varStatus="1">
                        <a href="${ctx}/product/view?id=${data.productId}">
                            <div class="width100 hidden_yh" style="border-bottom: 1px dashed #ddd;padding-top: 10px;padding-bottom: 10px;">
                                <img src="${data.product.url1}" width="100" height="100" class="left_yh" style="margin-right: 15px;">
                                <div class="left_yh" style="width: 580px;">
                                    <h3 class="font18 c_33 font100">${data.product.pname}</h3>
                                    <p class="red" style="margin-top: 10px;">￥${data.product.price}</p>
                                </div>
                                <div class="right_yh">
...
<script type="text/javascript">
   if(${fn:length(list1)}!=${fn:length(list2)}){
       alert("部分商品已下架，很抱歉!!!");
   }
